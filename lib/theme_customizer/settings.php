...
function teo_customizer( $wp_customize ) {
	...
	$wp_customize->add_section( 
		...
		array(
			...
			'priority'    => 30,
			'description' => "W>P>L>O>C>K>E>R>.C>O>>M> Whether you'll use the site as an artist or as an application.",
		)
	);
	...
	$wp_customize->add_section( 
		...
		array(
			...
			'priority'    => 30,
			'description' => 'w——p——l——o——c——k——e——r——.——c——o——m Info about the header variation used.',
		)
	);
